...
public partial class Toast : UIComponentBase, IDisposable
{
    ...
    private UI.ProgressBar toastProgressBar = default!;
    ...
    protected override async ValueTask DisposeAsync(bool disposing)
    {
        if (disposing)
        {
            await JS.InvokeVoidAsync("window.UI.toasts.dispose", ElementId);
            objRef?.Dispose();
        }
    ...
    /// </summary>
    public async Task HideAsync() => await JS.InvokeVoidAsync("window.UI.toasts.hide", ElementId);

    /// <summary>
    /// Reveals an element’s toast.
    /// </summary>
    public async Task ShowAsync() => await JS.InvokeVoidAsync("window.UI.toasts.show", ElementId, AutoHide, Delay, objRef);
